...
@NgModule({
  declarations: [AppComponent,TicketFormComponent,CreateTicketFormComponent, BuyTicketFormComponent, DetalleCompraFormComponent,ModificarDetalleCompraComponent],
  imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule, HttpClientModule,  FormsModule, TicketPanelComponent],
